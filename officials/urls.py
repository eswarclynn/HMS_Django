...
urlpatterns = [
    ...
    path('generate-attendance-sheet/', views.generate_attendance_sheet, {'block_id': None}, name='generate_attendance_sheet'),
    path('generate-attendance-sheet/<int:block_id>/', views.generate_attendance_sheet, name='generate_attendance_sheet'),
